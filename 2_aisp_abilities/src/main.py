...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("-r", "--request", default=None, help="Request file to use as prompt (default: request.txt).")
...
def main() -> None:
    ...
    request_stem = Path(args.request).stem
    output_root_dir = f"../results/{request_stem}"
    ...
    with progress:
        ...
        for model_key, model_config in models.items():
            ...
            if response is None:
                ...
                review_json = json.dumps(parse_response(review_prompt))
